...
png("plots/pca/pca_participant_characteristics.png", width = 3000, height = 2000, res = 300)

# Create and display the grid of plots
grid.arrange(
  p_age, p_rin,
  p_pmd, p_c9, p_sex,
  ncol = 3
...
png("plots/pca/pca_celltypes.png", width = 3000, height = 2000, res = 300)  # 300 DPI, suitable for publication
